...
export async function POST(req)
{
    try
    {
        ...
        const { fullName, email, industry, message, requests, company, country } = data;
        ...
        const pdf1 = path.join(
            ...
            "public",
            "email-pdf",
            "SHRIMP_SOLUTIONS_TEORA-DIGITAL.pdf"
        );
        const pdf2 = path.join(
            process.cwd(),
            "public",
            "email-pdf",
            "TRIAL_REPORT_SHRIMP_ Request.pdf"
        );
        ...
        await transporter.sendMail({
            ...
            attachments: [
                ...
                { filename: "TRIAL_REPORT_SHRIMP_ Request.pdf", path: pdf2 },
            ],
        });
    ...
    {
        console.log("Error in contact route:", error);
